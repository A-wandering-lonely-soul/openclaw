...
write_env_file() {
...

    {
        ...
        printf "WECHAT_BRIDGE_ENABLED=%s\n" "$WECHAT_BRIDGE_ENABLED"
        printf "WECHAT_BRIDGE_TOKEN=%s\n" "$WECHAT_BRIDGE_TOKEN"
        printf "WECHAT_BRIDGE_PROVIDER=%s\n" "$WECHAT_BRIDGE_PROVIDER"
        printf "WECHAT_BRIDGE_MODEL=%s\n" "$WECHAT_BRIDGE_MODEL"
        printf "WECHAT_BRIDGE_DEDUP_TTL_SECONDS=%s\n" "$WECHAT_BRIDGE_DEDUP_TTL_SECONDS"
